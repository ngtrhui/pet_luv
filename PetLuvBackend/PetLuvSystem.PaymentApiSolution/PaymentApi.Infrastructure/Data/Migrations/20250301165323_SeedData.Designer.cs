...
namespace PaymentApi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250301165323_SeedData")]
            ...
            modelBuilder.Entity("PaymentApi.Domain.Entities.PaymentStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PaymentStatusId = new Guid("aca8cf7e-7c5e-4a7c-8a24-07d5c9bdef4b"),
                            IsVisible = true,
                            PaymentStatusName = "Thanh toán qua VNPay"
                        },
                        new
                        {
                            PaymentStatusId = new Guid("06b04b04-d94d-4cd6-930a-2d6bf125d6ca"),
                            IsVisible = true,
